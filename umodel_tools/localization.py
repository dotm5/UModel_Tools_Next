...
_ZH_HANS_MESSAGES = {
    ...
    "CalabiyauGame Rules": "卡拉彼丘规则",
    "Wuthering Waves Rules": "鸣潮规则",
    "UEFormat Asset": "UEFormat 资产",
    "Material JSON Conflicts": "材质 JSON 冲突",
    "Texture Conflicts": "贴图冲突",
    "No conflicts recorded.": "未记录冲突。",
    "No candidates recorded.": "未记录候选项。",
    "Selected": "已选择",
    "Apply UEFormat Conflict Choice": "应用 UEFormat 冲突选择",
    "UEFormat conflict choice saved.": "UEFormat 冲突选择已保存。",
    "Rebuild UEFormat Asset Materials": "重建 UEFormat 资产材质",
    "UEFormat asset materials rebuilt.": "UEFormat 资产材质已重建。",
    "Import UEFormat Asset completed with warnings. Check console for details.": "UEFormat 资产导入已完成，但存在警告。请查看控制台详情。",
    "UEFormat import completed with warnings. Check console for details.": "UEFormat 导入已完成，但存在警告。请查看控制台详情。",
