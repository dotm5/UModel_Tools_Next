...
_ZH_HANS_MESSAGES = {
    ...
    "Import Unreal Engine map scenes into Blender": "将 Unreal Engine 地图场景导入 Blender",
    "Game": "游戏",
    ...
    "Map import had warnings. Check console for details.": "地图导入存在警告。请查看控制台了解详情。",
    "Map JSON path was not provided.": "未提供地图 JSON 路径。",
    "Rule file path was not provided.": "未提供规则文件路径。",
}
